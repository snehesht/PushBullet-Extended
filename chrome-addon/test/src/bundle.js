...
/***/ function(module, exports, __webpack_require__) {
	...
	var DemoApp = __webpack_require__(159);
	__webpack_require__(168);
	var SettingsView = __webpack_require__(166);
	var Help = __webpack_require__(174);
	...
	if (location.hash === "#Settings") {
		return ReactDOM.render(React.createElement(SettingsView, null),document.getElementById('mainContainer'));
	} 
	else if (location.hash === "#Help"){
		return ReactDOM.render(React.createElement(Help, null),document.getElementById('mainContainer'));
	}
	else {
		return ReactDOM.render(React.createElement(App, null),document.getElementById('mainContainer'));
	}
	}
...
/***/ function(module, exports, __webpack_require__) {
	...
	var React = __webpack_require__(1);
	var AppHeader = __webpack_require__(161);
	var AppBody = __webpack_require__(162);
	var AppFooter = __webpack_require__(165);

	var SettingsView = __webpack_require__(166);

	var Immutable = __webpack_require__(172);
		...
		render: function(){
			...
			return(
				React.createElement("div", {className: "container"}, 
					...
					React.createElement(AppBody, {pageTitle: this.state.pageTitle, pageURL: this.state.pageURL}), 
			...
			return(
				React.createElement("div", {className: "header"}, 
					React.createElement("ul", null, 
						React.createElement("li", {className: "logo"}, React.createElement("a", {href: "#"}, "P W A")), 
						React.createElement("li", {className: "closeButton", onClick: this.onClickClose}, React.createElement("a", {href: "#Close"}, React.createElement("i", {className: "fa fa-times"}))), 
						React.createElement("li", {className: "helpButton"}, React.createElement("a", {href: "#Help"}, React.createElement("i", {className: "fa fa-question-circle"}), React.createElement("span", {className: "textOptions"}, "Help"))), 
						React.createElement("li", {className: "settingsButton"}, React.createElement("a", {href: "#Settings"}, React.createElement("i", {className: "fa fa-cog"}), React.createElement("span", {className: "textOptions"}, "Settings")))
					)
				)
				);
		}
...
/***/ function(module, exports, __webpack_require__) {
	...
	var React = __webpack_require__(1);
	var FriendsList = __webpack_require__(163);
	...
	var AppBody = React.createClass({displayName: "AppBody",
		...
		render: function(){
			return(
					React.createElement("div", {className: "appBody"}, 
						React.createElement("form", {action: ""}, 
							React.createElement("div", {className: "formElement"}, 
								"Title:  ", React.createElement("input", {type: "text", name: "pageTitle", placeholder: "...", defaultValue: this.state.title})
							), 
							React.createElement("div", {className: "formElement"}, 
								"Link  : ", React.createElement("input", {type: "text", name: "pageURL", defaultValue: this.state.url})
							), 
							React.createElement("div", {className: "formElement"}, 
								"Tags  : ", React.createElement("input", {type: "text", name: "tagsList", placeholder: "saperate tags by comma"}), 
								React.createElement("button", null, "Add Tags")
							)
						), 

					React.createElement(FriendsList, {friends: this.state.friendslist})
...
/***/ function(module, exports, __webpack_require__) {
	...
	var React = __webpack_require__(1);
	var Friend = __webpack_require__(164);
	...
	var FriendsList = React.createClass({displayName: "FriendsList",
		...
		render: function(){
			...
			var friendslistfetched = this.props.friends.map(
						function(item){
							return(React.createElement(Friend, {key: item.uid, friendName: item.name, friendType: item.type, uid: item.uid}));
						}
						,this);
			return(
					React.createElement("div", {className: "friendsList"}, 
						React.createElement("ul", null, 
							React.createElement("span", {className: "friendsListTitle"}, "Friends List"), 
							friendslistfetched
						)
					)
				);
	...
	var Friend = React.createClass({displayName: "Friend",
		...
		render: function(){
			if (this.state.checked == true){
				return(
					React.createElement("li", {className: "friendActive", onClick: this.onClick}, 
						React.createElement("a", {href: "#", onClick: this.onClick}, this.props.friendName)
					)
				);
			} else {
				return(
					React.createElement("li", {className: "friend", onClick: this.onClick}, 
						React.createElement("a", {href: "#", onClick: this.onClick}, this.props.friendName)
					)
				);
			}
...
/***/ function(module, exports, __webpack_require__) {
	...
	var AppFooter = React.createClass({displayName: "AppFooter",
		...
		render: function(){
			return(
				React.createElement("div", {className: "appFooter"}, 
					React.createElement("ul", null, 
						React.createElement("li", null, 
							React.createElement("a", {href: "#AddFriend", className: "addFriendButton"}, " ", React.createElement("i", {className: "fa fa-plus-square"}), " Add Friend")
						), 
						React.createElement("li", null, 
							React.createElement("a", {href: "#", className: "viewHistoryButton", onClick: this.handleViewHistory}, React.createElement("i", {className: "fa fa-history"}), " View History")
						), 
						React.createElement("li", null, 
							React.createElement("a", {href: "#", className: "sendButton"}, React.createElement("i", {className: "fa fa-paper-plane-o"}), " Send")
						)
					)
				)
				);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var React = __webpack_require__(1);
	var AppHeader = __webpack_require__(161);
	var SettingsAccountInfo = __webpack_require__(167);
	var SettingsFeedback = __webpack_require__(173);
	...
	var SettingsView = React.createClass({displayName: "SettingsView",
		render: function(){
			return(
				React.createElement("div", {className: "container"}, 
					React.createElement(AppHeader, null), 
					React.createElement(SettingsAccountInfo, null), 
					React.createElement(SettingsFeedback, null)
				)
				);
		}
...
/***/ function(module, exports, __webpack_require__) {
	...
	var SettingsAccountInfo = React.createClass({displayName: "SettingsAccountInfo",
		render: function(){
			return(
				React.createElement("div", {className: "accountInfo"}, 
					React.createElement("ul", null, 
						React.createElement("li", {className: "profilepic"}, React.createElement("img", {src: "http://media.merchantcircle.com/20649169/Husky-Logo-100x100_full.gif", alt: ""})), 
						React.createElement("li", null, 
							React.createElement("ul", {className: "accountInfoText"}, 
								React.createElement("li", null, React.createElement("span", null, "John Doe")), 
								React.createElement("li", null, "john.doe@mail.uc.edu"), 
								React.createElement("li", null, React.createElement("br", null)), 
								React.createElement("ul", {className: "SettingsInlineBlock"}, 
									React.createElement("li", null, React.createElement("a", {href: "", className: "changePassword"}, "Change Password")), 
									React.createElement("li", null, React.createElement("a", {href: "", className: "logout"}, "Logout"))
								)
							)
						)
					)
...
/***/ function(module, exports, __webpack_require__) {
	...
	var SettingsFeedback = React.createClass({displayName: "SettingsFeedback",
		render: function(){
			return(
					React.createElement("div", {className: "feedbackContainer"}, 
						React.createElement("span", null, "Feedback"), 
						React.createElement("form", {action: ""}, 
							React.createElement("input", {type: "text", name: "feedbackInput"}), 
							React.createElement("p", null, " Please tell us your overall experience with the app, Select one of the check boxes below. "), 
							React.createElement("input", {type: "radio", name: "overallExperience", id: "good"}), React.createElement("span", null), React.createElement("label", {for: "good"}, "Good"), 
							React.createElement("input", {type: "radio", name: "overallExperience", id: "ok"}), React.createElement("span", null), React.createElement("label", {for: "good"}, "Ok"), 
							React.createElement("input", {type: "radio", name: "overallExperience", id: "bad"}), React.createElement("span", null), React.createElement("label", {for: "good"}, "Bad"), 
							React.createElement("a", {href: "", className: "FeedbackButton"}, "Send Feedback")
						)
					)
				);
		}
...
/***/ function(module, exports, __webpack_require__) {
	...
	var React = __webpack_require__(1);
	var AppHeader = __webpack_require__(161);
	var HelpInfo = __webpack_require__(175);
	...
	var Help = React.createClass({displayName: "Help",
		render: function(){
			return(
				React.createElement("div", {className: "container"}, 
					React.createElement(AppHeader, null), 
					React.createElement(HelpInfo, null)
				)
				);
		}
...
/***/ function(module, exports, __webpack_require__) {
	...
	var HelpInfo = React.createClass({displayName: "HelpInfo",
		render: function(){
			return(
				React.createElement("div", {className: "helpInfo"}, 
				React.createElement("span", {className: "helpTitle"}, "About the App"), 
				React.createElement("p", null, "The Personal Web Archive is built with the best features of both ", React.createElement("a", {target: "_blank", href: "https://archive.org/"}, "Archive.org"), " and Pushbullet in mind."), 
				React.createElement("p", null, "Website: ", React.createElement("a", {href: "http://webarchive.xyz"}, "webarchive.xyz")), 
				React.createElement("span", {className: "helpTitle"}, "How to use the app ? "), 
